...
async function initializeRealProtocol() {
  ...
  console.log("🚀 Inicializando protocolo Oráculo REAL...");

  // Initialize governance token REAL
  ...
  try {
    ...
    console.log("✅ Configuración del protocolo REAL inicializada");
  } catch (err) {
    console.log("Protocolo ya inicializado");
  }

  console.log("\n🎉 Protocolo Oráculo REAL listo!");
  console.log("Governance Mint:", govMintPDA.toString());
  console.log("Config PDA:", configPDA.toString());
}

initializeRealProtocol().catch(console.error);
